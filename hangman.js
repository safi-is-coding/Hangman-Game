...
let word_list = ['apple', 'banana', 'orange', 'grape', 'kiwi', 'strawberry', 'blueberry', 'watermelon', 'melon', 'pear', 'peach', 'plum', 'cherry', 'pineapple', 'mango', 'lemon', 'lime', 'grapefruit', 'coconut', 'papaya']
...
document.getElementById("word_length").innerHTML = `The word 
contains ` + String(display.length) + ` letters.`;
